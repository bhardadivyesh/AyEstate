  ...
  return (
    <div className="categories">
      ...
      <div className="profile">
        ...
        <img
          className="man-438081-960-720-icon"
          alt=""
          src={avatarImg}
        />
      </div>
      <div className="rectangle-group" onClick={()=>handleManageClick("Manage")}>
        <div className="group-item" />
        <div className="manage">Manage</div>
        <img className="product-3-icon" alt="" src={manage} />
      </div>
      ...
      <div className="rectangle-parent4" onClick={()=>handleManageClick("status")}>
        <div className="group-child7" />
        <div className="status">Status</div>
        <img className="check-list-1-icon" alt="" src={status} />
      </div>
      <div className="rectangle-parent5" onClick={()=>handleManageClick("membership")}>
        <div className="group-child8" />
        <div className="membershipAdmin">Membership</div>
        <img className="membership-1-icon" alt="" src={membership} />
      </div>
      <div className="rectangle-parent6" onClick={()=>handleManageClick("vendor")}>
